 ...
 * QHEAP1 solution
 */
public final class QHEAP1Solution {
    private int[] elements;
    private int size;

    private QHEAP1Solution() {
    }

    private QHEAP1Solution(int queries) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            QHEAP1Solution heap = new QHEAP1Solution(queries); // initialize the heap
